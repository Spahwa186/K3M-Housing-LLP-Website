        ...
        23148: function(t, e, i) {
            ...
            function m(t, e) {
                ...
                for (let g = 0; g < d; ++g) {
                    ...
                    u = (t._stacks || (t._stacks = {}))[l] = f(n, c, i), u[r] = o, u._top = p(u, a, !0, s.type), u._bottom = p(u, a, !1, s.type);
            ...
            class y {
                ...
                _dataCheck() {
                    ...
                    if ((0, s.i)(e)) {
                        ...
                        this._data = function(t, e) {
                            ...
                            let h, l, c;
                            for (h = 0, l = a.length; h < l; ++h) c = a[h], r[h] = {
                                [n]: c,
                                [o]: t[c]
                            };
                            return r
                ...
                buildOrUpdateElements(t) {
                    ...
                    this._dataCheck();
                    const n = e._stacked;
                    e._stacked = g(e.vScale, e), e.stack !== i.stack && (s = !0, _(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && (m(this, e._parsed), e._stacked = g(e.vScale, e))
                }
                configure() {
                ...
                getMinMax(t, e) {
                    ...
                    function p() {
                        f = n[g];
                        const e = f[r.axis];
                        return !(0, s.g)(f[t.axis]) || c > e || u < e
                    }
                    for (g = 0; g < a && (p() || (this.updateRangeFromParsed(l, t, f, h), !o)); ++g);
                    if (o)
                        for (g = a - 1; g >= 0; --g)
                            if (!p()) {
                ...
                _resolveElementOptions(t, e = "default", i) {
                    ...
                    const l = this.chart.config,
                        ...
                        f = l.resolveNamedOptions(u, g, (() => this.getContext(i, n, e)), d);
                    return f.$shared && (f.$shared = h, o[a] = Object.freeze(v(f, h))), f
                }
            ...
            class w extends y {
                ...
                update(t) {
                    const e = this.chart,
                        ...
                        } = this._getRotationExtents(),
                        {
                            ...
                            if (e < s.T) {
                                const h = t,
                                    ...
                                    u = Math.cos(l),
                                    g = Math.sin(l),
                                    f = (t, e, n) => (0, s.p)(t, h, l, !0) ? 1 : Math.max(e, e * i, n, n * i),
                                    p = (t, e, n) => (0, s.p)(t, h, l, !0) ? -1 : Math.min(e, e * i, n, n * i),
                                    m = f(0, c, u),
                                    x = f(s.H, d, g),
                                    _ = p(s.P, c, u),
                                    b = p(s.P + s.H, d, g);
                                n = (m - _) / 2, o = (x - b) / 2, a = -(m + _) / 2, r = -(x + b) / 2
                            }
                            return {
                                ratioX: n,
                                ratioY: o,
                        ...
                        m = (i.width - a) / u,
                        x = (i.height - a) / g,
                        _ = Math.max(Math.min(m, x) / 2, 0),
                        b = (0, s.n)(this.options.radius, _),
                        v = (b - Math.max(b * h, 0)) / this._getVisibleDatasetWeightTotal();
                    this.offsetX = f * b, this.offsetY = p * b, n.total = this.calculateTotal(), this.outerRadius = b - v * this._getRingWeightOffset(this.index), this.innerRadius = Math.max(this.outerRadius - v * l, 0), this.updateElements(o, 0, o.length, t)
                }
                _circumference(t, e) {
                    const i = this.options,
                        n = this._cachedMeta,
                        o = this._getCircumference();
                    return e && i.animation.animateRotate || !this.chart.getDataVisibility(t) || null === n._parsed[t] || n.data[t].hidden ? 0 : this.calculateCircumference(n._parsed[t] * o / s.T)
                }
                updateElements(t, e, i, s) {
                    const n = "reset" === s,
                        o = this.chart,
                    ...
                    for (p = e; p < e + i; ++p) {
                        ...
                        f && (o.options = g || this.resolveDataElementOptions(p, i.active ? "active" : s)), m += e, this.updateElement(i, p, o, s)
                    }
                }
                calculateTotal() {
                    const t = this._cachedMeta,
            ...
            var O = {
                evaluateInteractionItems: k,
                modes: {
                    index(t, e, i, n) {
                        const o = (0, s.z)(e, t),
                            a = i.axis || "x",
                            r = i.includeInvisible || !1,
                            h = i.intersect ? S(t, o, a, n, r) : A(t, o, a, !1, n, r),
                            l = [];
                    ...
                    dataset(t, e, i, n) {
                        const o = (0, s.z)(e, t),
                            a = i.axis || "xy",
                            r = i.includeInvisible || !1;
                        let h = i.intersect ? S(t, o, a, n, r) : A(t, o, a, !1, n, r);
                        if (h.length > 0) {
                    ...
                    nearest(t, e, i, n) {
                        const o = (0, s.z)(e, t),
                            a = i.axis || "xy",
                            r = i.includeInvisible || !1;
                        return A(t, o, a, i.intersect, n, r)
                    },
                    x: (t, e, i, n) => E(t, (0, s.z)(e, t), "x", i.intersect, n),
                    y: (t, e, i, n) => E(t, (0, s.z)(e, t), "y", i.intersect, n)
                }
            };
            const C = ["left", "top", "right", "bottom"];
            ...
            function H(t, e, i, n) {
                ...
                a.getPadding && R(r, a.getPadding());
                const h = Math.max(0, e.outerWidth - T(r, t, "left", "right")),
                    l = Math.max(0, e.outerHeight - T(r, t, "top", "bottom")),
                    c = h !== t.w,
                    d = l !== t.h;
            ...
            function W(t, e, i, s) {
                ...
                for (o = 0, a = t.length, l = 0; o < a; ++o) {
                    r = t[o], h = r.box, h.update(r.width || e.w, r.height || e.h, F(r.horizontal, e));
                    const {
                        same: a,
                        other: d
                    } = H(e, i, r, s);
            ...
            function V(t, e, i, n) {
                ...
                for (const h of t) {
                    ...
                    if (h.horizontal) {
                        const n = e.w * c,
                            a = l.size || t.height;
                        (0, s.h)(l.start) && (r = l.start), t.fullSize ? j(t, o.left, r, i.outerWidth - o.right - o.left, a) : j(t, e.left + l.placed, r, n, a), l.start = r, l.placed += n, r = t.bottom
                    } else {
                        const n = e.h * c,
                            r = l.size || t.width;
                        (0, s.h)(l.start) && (a = l.start), t.fullSize ? j(t, a, o.top, r, i.outerHeight - o.bottom - o.top) : j(t, a, e.top + l.placed, r, n), l.start = a, l.placed += n, a = t.right
                    }
                }
                e.x = a, e.y = r
            }
            var B = {
                ...
                update(t, e, i, n) {
                    ...
                    const o = (0, s.E)(t.options.layout.padding),
                        ...
                        h = function(t) {
                            const e = function(t) {
                                ...
                                i = P(e.filter((t => t.box.fullSize)), !0),
                                s = P(I(e, "left"), !0),
                                n = P(I(e, "right")),
                                o = P(I(e, "top"), !0),
                                a = P(I(e, "bottom")),
                    ...
                    const f = Object.assign({
                        ...
                        p = z(l.concat(c), u);
                    W(h.fullSize, f, u, p), W(l, f, u, p), W(c, f, u, p) && W(l, f, u, p),
                        function(t) {
                        ...
                        }(f), V(h.leftAndTop, f, u, p), f.x += f.w, f.y += f.h, V(h.rightAndBottom, f, u, p), t.chartArea = {
                            left: f.left,
                            top: f.top,
                            right: f.left + f.w,
                            bottom: f.top + f.h,
            ...
            function X(t, e, i) {
                t && t.canvas && t.canvas.removeEventListener(e, i, Q)
            }
            ...
            function K(t, e, i) {
                const s = t.canvas,
                    n = new MutationObserver((t => {
                        let e = !1;
                        for (const i of t) e = e || q(i.addedNodes, s), e = e && !q(i.removedNodes, s);
                        e && i()
                    }));
            ...
            function G(t, e, i) {
                const s = t.canvas,
                    n = new MutationObserver((t => {
                        let e = !1;
                        for (const i of t) e = e || q(i.removedNodes, s), e = e && !q(i.addedNodes, s);
                        e && i()
                    }));
                return n.observe(document, {
                    childList: !0,
            ...
            class pt extends ot {
                ...
                _computeLabelSizes(t, e, i) {
                    ...
                    let l, c, d, u, g, f, p, m, x, _, b, v = 0,
                        y = 0;
                    for (l = 0; l < e; l += h) {
                        if (u = t[l].label, g = this._resolveTickFontOptions(l), n.font = f = g.string, p = o[f] = o[f] || {
                                data: {},
                                gc: []
                            }, m = g.lineHeight, x = _ = 0, (0, s.k)(u) || (0, s.b)(u)) {
                            if ((0, s.b)(u))
                                for (c = 0, d = u.length; c < d; ++c) b = u[c], (0, s.k)(b) || (0, s.b)(b) || (x = (0, s.V)(n, p.data, p.gc, x, b), _ += m)
                        } else x = (0, s.V)(n, p.data, p.gc, x, u), _ = m;
                ...
                _computeGridLineItems(t) {
                    ...
                    let x, _, b, v, y, w, M, k, S, D, A, E;
                    if ("top" === a) x = m(this.bottom), w = this.bottom - d, k = x - p, D = m(t.top) + p, E = t.bottom;
                    else if ("bottom" === a) x = m(this.top), D = t.top, E = m(t.bottom) - p, w = x + p, k = this.top + d;
                    else if ("left" === a) x = m(this.right), y = this.right - d, M = x - p, S = m(t.left) + p, A = t.right;
                    else if ("right" === a) x = m(this.left), S = t.left, A = m(t.right) - p, y = x + p, M = this.left + d;
                    else if ("x" === e) {
                        ...
                        D = t.top, E = t.bottom, w = x + p, k = w + d
                    } else if ("y" === e) {
                        ...
                        y = x - p, M = y - d, S = t.left, A = t.right
                    }
                    const O = (0, s.v)(n.ticks.maxTicksLimit, c),
                    ...
                    for (_ = 0; _ < c; _ += C) {
                        ...
                        b = dt(this, _, h), void 0 !== b && (v = (0, s.X)(i, b, a), l ? y = M = S = A = v : w = k = D = E = v, u.push({
                            tx1: y,
                            ty1: w,
                            tx2: M,
                            ty2: k,
                ...
                _computeLabelItems(t) {
                    const e = this.axis,
                        ...
                        m = [];
                    let x, _, b, v, y, w, M, k, S, D, A, E, O = "middle";
                    if ("top" === n) w = this.bottom - f, M = this._getXAxisLabelAlignment();
                    else if ("bottom" === n) w = this.top + f, M = this._getXAxisLabelAlignment();
                    else if ("left" === n) {
                    ...
                    "y" === e && ("start" === h ? O = "top" : "end" === h && (O = "bottom"));
                    const C = this._getLabelSizes();
                    for (x = 0, _ = r.length; x < _; ++x) {
                        b = r[x], v = b.label;
                        const t = o.setContext(this.getContext(x));
                        k = this.getPixelForTick(x) + o.labelOffset, S = this._resolveTickFontOptions(x), D = S.lineHeight, A = (0, s.b)(v) ? v.length : 1;
                        const e = A / 2,
                            i = t.color,
                            h = t.textStrokeColor,
                            c = t.textStrokeWidth;
                        let u, g = M;
                        if (a ? (y = k, "inner" === M && (g = x === _ - 1 ? this.options.reverse ? "left" : "right" : 0 === x ? this.options.reverse ? "right" : "left" : "center"), E = "top" === n ? "near" === l || 0 !== p ? -A * D + D / 2 : "center" === l ? -C.highest.height / 2 - e * D + D : -C.highest.height + D / 2 : "near" === l || 0 !== p ? D / 2 : "center" === l ? C.highest.height / 2 - e * D : C.highest.height - A * D, d && (E *= -1), 0 === p || t.showLabelBackdrop || (y += D / 2 * Math.sin(p))) : (w = k, E = (1 - A) * D / 2), t.showLabelBackdrop) {
                ...
                drawTitle() {
                    ...
                    const {
                        ...
                        if (t.isHorizontal()) {
                            ...
                            } else f = "center" === i ? (c.bottom + c.top) / 2 + m - e : ht(t, i, e);
                            u = h - a
                        } else {
                            if ((0, s.i)(i)) {
                                const t = Object.keys(i)[0],
                            ...
                            f = (0, s.a2)(n, r, o), p = "left" === i ? -s.H : s.H
                        }
                        return {
                            titleX: g,
                            titleY: f,
                ...
                _layers() {
                    ...
                    return this._isVisible() && this.draw === pt.prototype.draw ? [{
                        z: i,
                        draw: t => {
            ...
            class xt {
                constructor() {
                    this.controllers = new mt(y, "datasets", !0), this.elements = new mt(ot, "elements"), this.plugins = new mt(Object, "plugins"), this.scales = new mt(pt, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
                }
                add(...t) {
            ...
            function kt(t, ...e) {
                if (Mt(t)) return t;
                for (const s of e) {
                    const e = s.axis || ("top" === (i = s.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.length > 1 && Mt(t[0].toLowerCase());
                    if (e) return e
                }
                var i;
            ...
            function It(t, e) {
                let i = Ot.get(t);
                return i || (i = e(), Ot.set(t, i), Ct.add(i)), i
            }
            const Lt = (t, e, i) => {
                const n = (0, s.f)(e, i);
                void 0 !== n && t.add(n)
            ...
            class Pt {
                constructor(t) {
                    this._config = function(t) {
                        return (t = t || {}).data = Et(t.data), At(t), t
                ...
                getOptionScopes(t, e, i) {
                    ...
                    const h = new Set;
                    e.forEach((e => {
                        t && (h.add(t), e.forEach((e => Lt(h, t, e)))), e.forEach((t => Lt(h, n, t))), e.forEach((t => Lt(h, s.a3[o] || {}, t))), e.forEach((t => Lt(h, s.d, t))), e.forEach((t => Lt(h, s.a6, t)))
                    }));
                    const l = Array.from(h);
                    return 0 === l.length && l.push(Object.create(null)), Ct.has(e) && a.set(e, l), l
                }
                chartOptionScopes() {
                    const {
                        options: t,
                    ...
                    if (function(t, e) {
                            ...
                            for (const o of e) {
                                const e = i(o),
                                    a = n(o),
                                    r = (a || e) && t[o];
                                if (e && ((0, s.a7)(r) || Tt(r)) || a && (0, s.b)(r)) return !0
                            }
                            return !1
                        }(a, e)) {
            ...
            const Tt = t => (0, s.i)(t) && Object.getOwnPropertyNames(t).some((e => (0, s.a7)(t[e])));
            const Rt = ["top", "bottom", "left", "right", "chartArea"];

            function Ht(t, e) {
                return "top" === t || "bottom" === t || -1 === Rt.indexOf(t) && "x" === e
            }
            ...
            const Bt = {},
                $t = t => {
                    const e = Vt(t);
                    return Object.values(Bt).filter((t => t.canvas === e)).pop()
                };
            ...
            class Yt {
                ...
                buildOrUpdateScales() {
                    ...
                    e && (o = o.concat(Object.keys(e).map((t => {
                        ...
                        void 0 !== o.position && Ht(o.position, r) === Ht(e.dposition) || (o.position = e.dposition), n[a] = !0;
                        let l = null;
                        ...
                        B.configure(this, t, t.options), B.addBox(this, t)
                    }))
                }
                _updateMetasets() {
                    ...
                    this._sortedMetasets = t.slice(0).sort(Ft("order", "index"))
                }
                ...
                _updateLayout(t) {
                    ...
                    B.update(this, this.width, this.height, t);
                ...
                render() {
                    !1 !== this.notifyPlugins("beforeRender", {
                        cancelable: !0
                    }) && (o.has(this) ? this.attached && !o.running(this) && o.start(this) : (this.draw(), Wt({
                        chart: this
                    })))
                }
                draw() {
                ...
                destroy() {
                    ...
                    this._stop(), this.config.clearCache(), t && (this.unbindEvents(), (0, s.af)(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete Bt[this.id], this.notifyPlugins("afterDestroy")
                }
                toBase64Image(...t) {
            ...
            function Xt(t, e, i, n) {
                const o = (a = t.options.borderRadius, (0, s.ak)(a, ["outerStart", "outerEnd", "innerStart", "innerEnd"]));
                var a;
                const r = (i - e) / 2,
                    h = Math.min(r, n * e / 2),
                    l = t => {
            ...
            function Kt(t, e, i, n, o, a) {
                const {
                    ...
                    pixelMargin: c,
                    innerRadius: d
                } = e, u = Math.max(e.outerRadius + n + i - c, 0), g = d > 0 ? d + n + i + c : 0;
                let f = 0;
                const p = o - l;
                if (n) {
                ...
                const m = (p - Math.max(.001, p * u - i / s.P) / u) / 2,
                    x = l + m + f,
                    _ = o - m - f,
                    {
                        outerStart: b,
                ...
                if (t.beginPath(), a) {
                    ...
                    if (t.arc(r, h, u, S, e), t.arc(r, h, u, e, D), v > 0) {
                        const e = qt(k, D, r, h);
                        t.arc(e.x, e.y, v, D, _ + s.H)
                    }
                    const i = qt(E, _, r, h);
                    if (t.lineTo(i.x, i.y), w > 0) {
                        const e = qt(E, C, r, h);
                        t.arc(e.x, e.y, w, _ + s.H, C + Math.PI)
                    }
                    const n = (_ - w / g + (x + y / g)) / 2;
                    if (t.arc(r, h, g, _ - w / g, n, !0), t.arc(r, h, g, n, x + y / g, !0), y > 0) {
                        const e = qt(A, O, r, h);
                        t.arc(e.x, e.y, y, O + Math.PI, x - s.H)
                    }
                    const o = qt(M, x, r, h);
                    if (t.lineTo(o.x, o.y), b > 0) {
                        const e = qt(M, S, r, h);
                        t.arc(e.x, e.y, b, x - s.H, S)
                    }
                } else {
                    t.moveTo(r, h);
            ...
            function Gt(t, e, i, n, o) {
                ...
                if (!c) return;
                t.setLineDash(u || []), t.lineDashOffset = g, f ? (t.lineWidth = 2 * c, t.lineJoin = d || "round") : (t.lineWidth = c, t.lineJoin = d || "bevel");
                let p = e.endAngle;
                if (a) {
                    Kt(t, e, i, n, p, o);
                    for (let e = 0; e < a; ++e) t.stroke();
                    isNaN(h) || (p = r + (h % s.T || s.T))
                }
                f && function(t, e, i) {
                    const {
                        startAngle: n,
                    ...
                    let c = o / h;
                    t.beginPath(), t.arc(a, r, h, n - c, i + c), l > o ? (c = o / l, t.arc(a, r, l, i + c, n - c, !0)) : t.arc(a, r, o, i + s.H, n - s.H), t.closePath(), t.clip()
                }(t, e, p), a || (Kt(t, e, i, n, p, o), t.stroke())
            }
            class Jt extends ot {
                static id = "arc";
                static defaults = {
                ...
                draw(t) {
                    ...
                    t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor,
                        function(t, e, i, n, o) {
                            ...
                            Kt(t, e, i, n, l, o), t.fill()
                        }(t, this, h, o, a), Gt(t, this, h, o, a), t.restore()
                }
            }
            const Zt = (t, e) => {
                let {
            ...
            class te extends ot {
                ...
                _fitRows(t, e, i, s) {
                    ...
                    return this.legendItems.forEach(((t, g) => {
                        ...
                        (0 === g || h[h.length - 1] + f + 2 * a > o) && (c += l, h[h.length - (g > 0 ? 0 : 1)] = 0, u += l, d++), r[g] = {
                            left: 0,
                            top: u,
                            row: d,
                            width: f,
                ...
                _draw() {
                    ...
                    const {
                        ...
                        boxHeight: p,
                        itemHeight: m
                    } = Zt(a, d), x = this.isHorizontal(), _ = this._computeTitleHeight();
                    g = x ? {
                    ...
                    this.legendItems.forEach(((v, y) => {
                        ...
                        const w = n.measureText(v.text).width,
                            M = h.textAlign(v.textAlign || (v.textAlign = a.textAlign)),
                            k = f + u + w;
                        let S = g.x,
                            D = g.y;
                        h.setWidth(this.width), x ? y > 0 && S + k + c > this.right && (D = g.y += b, g.line++, S = g.x = (0, s.a2)(o, this.left + c, this.right - i[g.line])) : y > 0 && D + b > this.bottom && (S = g.x = S + e[g.line].width + c, g.line++, D = g.y = (0, s.a2)(o, this.top + _ + c, this.bottom - e[g.line].height));
                        if (function(t, e, i) {
                                ...
                                if (n.fillStyle = (0, s.v)(i.fillStyle, r), n.lineCap = (0, s.v)(i.lineCap, "butt"), n.lineDashOffset = (0, s.v)(i.lineDashOffset, 0), n.lineJoin = (0, s.v)(i.lineJoin, "miter"), n.lineWidth = o, n.strokeStyle = (0, s.v)(i.strokeStyle, r), n.setLineDash((0, s.v)(i.lineDash, [])), a.usePointStyle) {
                                    const r = {
                                        ...
                                        l = h.xPlus(t, f / 2),
                                        c = e + u;
                                    (0, s.aD)(n, r, l, c, a.pointStyleWidth && f)
                                } else {
                                    ...
                                    n.beginPath(), Object.values(l).some((t => 0 !== t)) ? (0, s.au)(n, {
                                        ...
                                        h: p,
                                        radius: l
                                    }) : n.rect(r, a, f, p), n.fill(), 0 !== o && n.stroke()
                                }
                                n.restore()
                            }(h.x(S), D, v), S = (0, s.aB)(M, S + f + u, x ? S + k : this.right, t.rtl), function(t, e, i) {
            ...
            var ie = {
                ...
                _element: te,
                start(t, e, i) {
                    const s = t.legend = new te({
                        ctx: t.ctx,
                        options: i,
                        chart: t
                    });
                    B.configure(t, s, i), B.addBox(t, s)
                },
                stop(t) {
                    B.removeBox(t, t.legend), delete t.legend
                },
                beforeUpdate(t, e, i) {
                    const s = t.legend;
                    B.configure(t, s, i), s.options = i
                },
                afterUpdate(t) {
                    const e = t.legend;
            ...
            new WeakMap;
            s.aF, s.aF, s.aF, s.aF, s.aF, s.aF, s.aF, s.aF, s.aF;
